...
{
    default void addSubscriber(String name, SubscriberPrx subscriber)
    {
        addSubscriber(name, subscriber, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void addSubscriber(String name, SubscriberPrx subscriber, java.util.Map<String, String> context)
    {
        _iceI_addSubscriberAsync(name, subscriber, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> addSubscriberAsync(String name, SubscriberPrx subscriber)
    {
        return _iceI_addSubscriberAsync(name, subscriber, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> addSubscriberAsync(String name, SubscriberPrx subscriber, java.util.Map<String, String> context)
    {
        return _iceI_addSubscriberAsync(name, subscriber, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_addSubscriberAsync(String iceP_name, SubscriberPrx iceP_subscriber, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void removeSubscriber(String name)
    {
        removeSubscriber(name, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void removeSubscriber(String name, java.util.Map<String, String> context)
    {
        _iceI_removeSubscriberAsync(name, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> removeSubscriberAsync(String name)
    {
        return _iceI_removeSubscriberAsync(name, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> removeSubscriberAsync(String name, java.util.Map<String, String> context)
    {
        return _iceI_removeSubscriberAsync(name, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_removeSubscriberAsync(String iceP_name, java.util.Map<String, String> context, boolean sync)
    {
