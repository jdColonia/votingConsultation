...
{
    default ConsultationResponse getVotingStation(String voterId)
        throws SystemException,
               VoterNotFoundException
    {
        return getVotingStation(voterId, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default ConsultationResponse getVotingStation(String voterId, java.util.Map<String, String> context)
        throws SystemException,
               VoterNotFoundException
    {
        try
        {
            return _iceI_getVotingStationAsync(voterId, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<ConsultationResponse> getVotingStationAsync(String voterId)
    {
        return _iceI_getVotingStationAsync(voterId, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<ConsultationResponse> getVotingStationAsync(String voterId, java.util.Map<String, String> context)
    {
        return _iceI_getVotingStationAsync(voterId, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<ConsultationResponse> _iceI_getVotingStationAsync(String iceP_voterId, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<ConsultationResponse> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getVotingStation", null, sync, _iceE_getVotingStation);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_voterId);
                 }, istr -> {
                     ConsultationResponse ret;
                     ret = ConsultationResponse.ice_read(istr);
                     return ret;
                 });
        return f;
    }
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getVotingStation =
    {
        SystemException.class,
        VoterNotFoundException.class
    };

    default ConsultationResponse[] getMultipleVotingStations(String[] voterIds)
        throws SystemException
    {
        return getMultipleVotingStations(voterIds, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default ConsultationResponse[] getMultipleVotingStations(String[] voterIds, java.util.Map<String, String> context)
        throws SystemException
    {
        try
        {
            return _iceI_getMultipleVotingStationsAsync(voterIds, context, true).waitForResponseOrUserEx();
        }
        catch(SystemException ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<ConsultationResponse[]> getMultipleVotingStationsAsync(String[] voterIds)
    {
        return _iceI_getMultipleVotingStationsAsync(voterIds, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<ConsultationResponse[]> getMultipleVotingStationsAsync(String[] voterIds, java.util.Map<String, String> context)
    {
        return _iceI_getMultipleVotingStationsAsync(voterIds, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<ConsultationResponse[]> _iceI_getMultipleVotingStationsAsync(String[] iceP_voterIds, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<ConsultationResponse[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getMultipleVotingStations", null, sync, _iceE_getMultipleVotingStations);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeStringSeq(iceP_voterIds);
                 }, istr -> {
                     ConsultationResponse[] ret;
                     ret = ConsultationResponseSeqHelper.read(istr);
                     return ret;
                 });
        return f;
    }
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getMultipleVotingStations =
    {
        SystemException.class
    };
